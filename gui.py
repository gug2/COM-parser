...
class Ui_window(object):
    def setupUi(self, window):
        ...
        self.importSettingsGroup.setGeometry(QtCore.QRect(5, 90, 490, 405))
        self.importSettingsGroup.setFlat(True)
        self.importSettingsGroup.setObjectName("importSettingsGroup")
        self.lineEdit = QtWidgets.QLineEdit(self.importSettingsGroup)
        self.lineEdit.setEnabled(False)
        self.lineEdit.setGeometry(QtCore.QRect(60, 30, 113, 20))
        self.lineEdit.setObjectName("lineEdit")
        self.label = QtWidgets.QLabel(self.importSettingsGroup)
        self.label.setGeometry(QtCore.QRect(10, 30, 47, 13))
        self.label.setObjectName("label")
        self.pushButton = QtWidgets.QPushButton(self.importSettingsGroup)
        self.pushButton.setEnabled(False)
        self.pushButton.setGeometry(QtCore.QRect(410, 20, 75, 23))
        self.pushButton.setAutoDefault(False)
        self.pushButton.setFlat(False)
        self.pushButton.setObjectName("pushButton")
        self.pushButton_2 = QtWidgets.QPushButton(self.importSettingsGroup)
        self.pushButton_2.setGeometry(QtCore.QRect(320, 20, 75, 23))
    ...
    def retranslateUi(self, window):
        ...
        self.importSettingsGroup.setTitle(_translate("window", "Import settings"))
        self.lineEdit.setText(_translate("window", ","))
        self.label.setText(_translate("window", "Delimiter"))
        self.pushButton.setText(_translate("window", "Save"))
        self.pushButton_2.setText(_translate("window", "Edit"))
        self.comPorts.setTitle(_translate("window", "COM-ports"))
        self.view.setTitle(_translate("window", "View"))
        self.updateSerialsAction.setText(_translate("window", "Update serials - F5"))
        self.action.setText(_translate("window", "Import settings"))
        self.action_2.setText(_translate("window", "График"))
        self.graphAction.setText(_translate("window", "Graph - F1"))
